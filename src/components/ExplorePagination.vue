...
export default {
  ...
  methods: {
    previousPage(currentPage) {
      return [0, 1].includes(currentPage - 1) ? `${this.basePath}/explore` : `${this.basePath}/explore/${currentPage - 1}/`;
    },
    nextPage(currentPage, totalPages) {
      return totalPages > currentPage ? `${this.basePath}/explore/${currentPage + 1}/` : `${this.basePath}/explore/${currentPage}/`;
    }
  },
  computed: {
    basePath() {
