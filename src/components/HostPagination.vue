...
export default {
  ...
  methods: {
    previousPage(currentPage) {
      return [0, 1].includes(currentPage - 1) ? `${this.basePath}/stay` : `${this.basePath}/stay/${currentPage - 1}/`;
    },
    nextPage(currentPage, totalPages) {
      return totalPages > currentPage ? `${this.basePath}/stay/${currentPage + 1}/` : `${this.basePath}/stay/${currentPage}/`;
    }
  },
  computed: {
    basePath() {
